...
- Flags dynamic patterns such as event emitters, DI, and dynamic imports that limit static analysis
...
- Covers module purpose, architecture glossary, key decisions and why they were made, dependency map, common change patterns, and known gotchas
...
The first run saves your language preference and skill level to `.codelingo/config.json`. Subsequent runs skip those questions.

To reset the skill level, delete the `skillLevel` field from `.codelingo/config.json`.
